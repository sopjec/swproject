...
public class AICoaching extends HttpServlet {
    ...
    // Fine-Tuned 모델의 ID
    private static final String FINE_TUNED_MODEL_ID = "ft:gpt-3.5-turbo-0125:personal::AZNbIIi1";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        System.out.println("[DEBUG] Received Request Body: " + body);
        ...
        systemMessage.addProperty("content", "다음 입력에 기반하여 주요 키워드를 식별하고 구체적인 수정 제안을 제공합니다.");
