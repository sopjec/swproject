...
public class VideoUploadServlet extends HttpServlet {
    ...
    private static final String VIDEO_FOLDER = "/videos"; // 상대 경로 설정
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 저장 경로를 "videos/자소서제목_인터뷰ID"로 설정
        String folderName = resumeTitle + "_" + interviewId; // 하위 폴더 이름
        String savePath = getServletContext().getRealPath(VIDEO_FOLDER + "/" + folderName); // 하위 폴더 경로
        ...
        for (Part part : request.getParts()) {
            ...
            if (originalFileName != null && !originalFileName.isEmpty()) {
                ...
                String uniqueFileName = "webcam_recording" + fileExtension; // 녹화된 파일명 지정
